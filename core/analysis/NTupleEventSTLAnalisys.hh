...
class NTupleEventSTLAnalisys {

  private:
    ///
    NTupleEventSTLAnalisys() = default;

    ///
    ~NTupleEventSTLAnalisys() = default;

    /// Delete the copy and move constructors
    NTupleEventSTLAnalisys(const NTupleEventSTLAnalisys &) = delete;

    NTupleEventSTLAnalisys &operator=(const NTupleEventSTLAnalisys &) = delete;

    NTupleEventSTLAnalisys(NTupleEventSTLAnalisys &&) = delete;

    NTupleEventSTLAnalisys &operator=(NTupleEventSTLAnalisys &&) = delete;
    ...
    class TTreeCollection {
      public:
        ...
        /// see NTupleEventSTLAnalisys::DefineTTree definition
  ...
  public:
    ///
    static NTupleEventSTLAnalisys* GetInstance();
